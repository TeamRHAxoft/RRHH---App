...
export default function AddCandidateModal({ stages, onClose, onAdded }) {
  const [form, setForm] = useState({ name: '', position: '', stage: stages[0], notes: '' })
    ...
    <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md">
        <div className="flex items-center justify-between p-5 border-b">
          <h3 className="font-semibold text-gray-800">Nuevo candidato</h3>
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Observaciones, contacto, etc."
            />
          </div>
