...
export default function TaskColumn({ status, colorClass, tasks, onDelete, onUpdate, onTogglePin, onArchive, onMoveToCurrentWeek, onMoveWeek, readOnly, currentProfile, profiles, weekKey, weekEndKey }) {
  return (
